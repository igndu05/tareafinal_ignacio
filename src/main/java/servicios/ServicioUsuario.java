...
public class ServicioUsuario {
    ...
    public static void insertarUsuariosEjemplo() {
        ...
        lista.add(new Usuario(1, "75950015H", "La Linea", "677 29 34 42"));
        lista.add(new Usuario(1, "75950015K", "La Linea", "677 29 34 43"));
        lista.add(new Usuario(1, "75950015L", "La Linea", "677 29 34 44"));
        lista.add(new Usuario(1, "75950015M", "La Linea", "677 29 34 45"));
